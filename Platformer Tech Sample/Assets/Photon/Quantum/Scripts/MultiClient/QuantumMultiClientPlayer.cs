...
public class QuantumMultiClientPlayer : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, IInRoomCallbacks, IOnEventCallback {
  ...
  DispatcherSubscription _quantumGameDisconnectedSubscription;
  ...
  public void Stop() {
    ...
    QuantumCallback.Unsubscribe(_quantumGameDisconnectedSubscription);
  ...
  private void OnQuantumPluginDisconnected(QuantumGame game) {
    Stop();
  }
  ...
  private void StartQuantumGame() {
    ...
    _quantumGameDisconnectedSubscription = QuantumCallback.Subscribe(this, (CallbackPluginDisconnect c) => OnQuantumPluginDisconnected(c.Game), game => game == _runner.Game);
