...
public unsafe class EntityView : MonoBehaviour, IQuantumPrefabNestedAssetHost {
  ...
  [Tooltip("A factor with dimension of 1/s (Hz) that works as a lower limit for how much of the accumulated " +
           "prediction error is corrected every frame. This factor affects both the position and the rotation " +
           "correction. Suggested values are greater than zero and smaller than ErrorCorrectionRateMax." +
           "\n\n" +
           "E.g.: ErrorCorrectionRateMin = 3, rendering delta time = (1/60)s: at least 5% (3 * 1/60) of the " +
           "accumulated error will be corrected on this rendered frame. " +
           "\n\n" +
           "This threshold might not be respected if the resultant correction magnitude is below the " +
           "ErrorPositionMinCorrection or above the ErrorPositionTeleportDistance, for the position error, or above " +
           "the ErrorRotationTeleportDistance, for the rotation error.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("A factor with dimension of 1/s (Hz) that works as a upper limit for how much of the accumulated prediction " +
           "error is corrected every frame. This factor affects both the position and the rotation correction. " +
           "Suggested values are greater than ErrorCorrectionRateMin and smaller than half of a target rendering rate." +
           "\n\n" +
           "E.g.: ErrorCorrectionRateMax = 15, rendering delta time = (1/60)s: at maximum 25% (15 * 1/60) of the " +
           "accumulated error will be corrected on this rendered frame. " +
           "\n\n" +
           "This threshold might not be respected if the resultant correction magnitude is below the " +
           "ErrorPositionMinCorrection or above the ErrorPositionTeleportDistance, for the position error, or above " +
  ...
  /// </para>
  /// </summary>
  [Tooltip("The reference for the magnitude of the accumulated position error, in meters, at which the position " +
           "error will be corrected at the ErrorCorrectionRateMin. Suggested values are greater than " +
           "ErrorPositionMinCorrection and smaller than ErrorPositionBlendEnd." +
           "\n\n" +
           "In other words, if the magnitude of the accumulated error is equal to or smaller than this threshold, " +
           "it will be corrected at the ErrorCorrectionRateMin. If, instead, the magnitude is between this " +
           "threshold and ErrorPositionBlendEnd,the error is corrected at a rate between ErrorCorrectionRateMin " +
           "and ErrorCorrectionRateMax, proportionally. If it is equal to or greater than ErrorPositionBlendEnd, " +
           "it will be corrected at the ErrorCorrectionRateMax." +
           "\n\n" +
           "Note: as the factor is expressed in distance units (meters), it might need to be scaled proportionally " +
           "to the overall scale of objects in the scene and speeds at which they move, which are factors that " +
           "affect the expected magnitude of prediction errors.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("The reference for the magnitude of the accumulated position error, in meters, " +
           "at which the position error will be corrected at the ErrorCorrectionRateMax. " +
           "Suggested values are greater than ErrorPositionBlendStart and smaller than ErrorPositionTeleportDistance." +
           "\n\n" +
           "In other words, if the magnitude of the accumulated error is equal to or greater than this threshold, " +
           "it will be corrected at the ErrorCorrectionRateMax. If, instead, the magnitude is between " +
           "ErrorPositionBlendStart and this threshold, the error is corrected at a rate between " +
           "ErrorCorrectionRateMin and ErrorCorrectionRateMax, proportionally. If it is equal to or smaller than " +
           "ErrorPositionBlendStart, it will be corrected at the ErrorCorrectionRateMin." +
           "\n\n" +
           "Note: as the factor is expressed in distance units (meters), it might need to be scaled proportionally " +
           "to the overall scale of objects in the scene and speeds at which they move, which are factors that " +
           "affect the expected magnitude of prediction errors.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("The reference for the magnitude of the accumulated rotation error, in radians, at which the rotation error " +
           "will be corrected at the ErrorCorrectionRateMin. Suggested values are smaller than ErrorRotationBlendEnd." +
           "\n\n" +
           "In other words, if the magnitude of the accumulated error is equal to or smaller than this threshold, " +
           "it will be corrected at the ErrorCorrectionRateMin. If, instead, the magnitude is between this " +
           "threshold and ErrorRotationBlendEnd, the error is corrected at a rate between ErrorCorrectionRateMin " +
           "and ErrorCorrectionRateMax, proportionally. If it is equal to or greater than ErrorRotationBlendEnd, " +
           "it will be corrected at the ErrorCorrectionRateMax.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("The reference for the magnitude of the accumulated rotation error, in radians, at which the rotation " +
           "error will be corrected at the ErrorCorrectionRateMax. Suggested values are greater than " +
           "ErrorRotationBlendStart and smaller than ErrorRotationTeleportDistance." +
           "\n\n" +
           "In other words, if the magnitude of the accumulated error is equal to or greater than this threshold, " +
           "it will be corrected at the ErrorCorrectionRateMax. If, instead, the magnitude is between " +
           "ErrorRotationBlendStart and this threshold, the error is corrected at a rate between " +
           "ErrorCorrectionRateMin and ErrorCorrectionRateMax, proportionally. If it is equal to or smaller than " +
           "ErrorRotationBlendStart, it will be corrected at the ErrorCorrectionRateMin.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("The value, in meters, that represents the minimum magnitude of the accumulated position error that will " +
           "be corrected in a single frame, until it is fully corrected." +
           "\n\n" +
           "This setting has priority over the resultant correction rate, i.e. the restriction will be respected " +
           "even if it makes the effective correction rate be different than the one computed according to the " +
           "min/max rates and start/end blend values. Suggested values are greater than zero and smaller than " +
  ...
  /// </para>
  /// </summary>
  [Tooltip("The value, in meters, that represents the magnitude of the accumulated position error above which the " +
           "error will be instantaneously corrected, effectively teleporting the rendered object to its correct " +
           "position. Suggested values are greater than ErrorPositionBlendEnd." +
           "\n\n" +
           "This setting has priority over the resultant correction rate, i.e. the restriction will be respected " +
           "even if it makes the effective correction rate be different than the one computed according to the " +
           "min/max rates and start/end blend values." +
           "\n\n" +
           "Note: as the factor is expressed in distance units (meters), it might need to be scaled proportionally " +
           "to the overall scale of objects in the scene and speeds at which they move, which are factors that " +
           "affect the expected magnitude of prediction errors.")]
  ...
  /// </para>
  /// </summary>
  [Tooltip("The value, in radians, that represents the magnitude of the accumulated rotation error above which the " +
           "error will be instantaneously corrected, effectively teleporting the rendered object to its correct " +
           "orientation. Suggested values are greater than ErrorRotationBlendEnd." +
           "\n\n" +
           "This setting has priority over the resultant correction rate, i.e. the restriction will be respected " +
           "even if it makes the effective correction rate be different than the one computed according to the " +
           "min/max rates and start/end blend values.")]
  ...
  void UpdateRenderPosition(ref UpdatePostionParameter param) {
    ...
    HostProfiler.Start("EntityView.ApplyTransform");
